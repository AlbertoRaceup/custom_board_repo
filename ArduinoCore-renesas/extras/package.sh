...
cp ../boards.txt ../boards.txt.original
cp ../platform.txt ../platform.txt.original
...
cp ../platform.txt.original ../platform.txt
cp ../boards.txt.original ../boards.txt
...
sed -i 's/portenta_c33./#portenta_c33./g' boards.txt
sed -i 's/muxto./#muxto./g' boards.txt
sed -i 's/Arduino Renesas fsp Boards/Raceup ATC Boards/g' platform.txt
